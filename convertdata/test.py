...
games = [
    {
        "game": "Blue Archive",
        "items": ["CraftSkip", "ExpChar", "Hat", "ExSkill" , "IconExp"]
    },
    {
        "game": "Clash of Clans",
        "items": ["Book", "Runa", "Potion", "PetHouse", "TownHall"]
    },
    {
        "game": "Genshin Impact",
        "items": ["Crown", "Ring", "Exp", "Stone", "Energy"]
    },
    {
        "game": "Hay Day",
        "items": ["Bread", "Corn", "Egg", "Milk" , "Wheat"]
    },
    {
        "game": "Honkai Impact 3",
        "items": ["Card", "Chip", "GoodSalt", "RankUp", "SkillMaterial"]
    },
    {
        "game": "Honkai Star Rail",
        "items": ["Pass", "Bullet", "Destiny", "DevineAmber", "Key"]
    },
    {
        "game": "Candy Crush Saga",
        "items": ["BlueEgg", "Cocout", "RedCandy", "LuckyCandy", "ColorFish"]
    },
    {
        "game": "Wuthering Waves",
        "items": ["ActivityPoints", "AfterGlowCoral", "CharWaveband", "CookingOil", "StarLight"]
    },
    {
        "game": "Zenless Zone Zero",
        "items": ["EatherChip", "EggBangboo", "ExpBangboo", "ExpChar", "IronRed"]
    }
]
